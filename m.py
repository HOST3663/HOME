...
API_TOKEN = '7500665941:AAGQTozBzAe2kudC2Rp1rOjRxUsfhCAfsYw'
ADMIN_USERNAME = '@Animelover24'
ADMIN_CHAT_ID = 7446142108  # Admin chat ID
...
async def send_welcome(message: types.Message):
    ...
    if user_id == ADMIN_CHAT_ID or user_id in approved_users:
        await message.answer(f"✅ Welcome @Animelover24!\nSend a .txt file to start CC checking.")
    else:
